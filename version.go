...
var (
	...
	// URL is the repository URL (https), defaults to "https://github.com/woozymasta/tml-gen".
	URL = "https://github.com/woozymasta/tml-gen"
...
// PrintVersion writes build information (URL, binary file path, version,
...
// VersionInfo returns a BuildInfo struct populated with the current
